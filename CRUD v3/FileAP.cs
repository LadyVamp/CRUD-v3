...
namespace CRUD_v3
{
    ...
    //В этом видео нет связи с БД, но есть копирование выделенной строки в текстбоксы https://www.youtube.com/watch?v=0flYZTNE7RU
    public partial class FileAP : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSaveFile_Click(object sender, EventArgs e)
        {
            ...
            table.Rows.Add(txtFileName.Text, txtKeywords.Text, txtSize.Text, cmbFormat.Text, txtContent.Text, cmbCatalog.Text);
            FileGrid.DataSource = table;
        ...
        private void FileGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtContent.Text = row.Cells[1].Value.ToString();
            cmbCatalog.Text = row.Cells[2].Value.ToString();
        }

        // button update datagridview selected row
        private void btnUpdFile_Click(object sender, EventArgs e)
        {
            DataGridViewRow newDataRow = FileGrid.Rows[selectedRow];
            newDataRow.Cells[0].Value = txtFileName.Text;
            newDataRow.Cells[1].Value = txtKeywords.Text;
            newDataRow.Cells[2].Value = txtSize.Text;
            newDataRow.Cells[3].Value = cmbFormat.Text;
            newDataRow.Cells[4].Value = txtContent.Text;
            newDataRow.Cells[5].Value = cmbCatalog.Text;
        ...
        private void btnDelFile_Click(object sender, EventArgs e)
        {
            ...
            selectedRow = FileGrid.CurrentCell.RowIndex;
            FileGrid.Rows.RemoveAt(selectedRow);
